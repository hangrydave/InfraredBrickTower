...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "IBT Controller", nullptr, nullptr);
    if (window == nullptr)
        return 1;
...
#else
    while (!glfwWindowShouldClose(window) && !couldNotAccessTower)
#endif
    {
        ...
        */
        ...
        IBTUI::BuildInfoWindow(mainViewport);
        IBTUI::BuildLASMWindow(mainViewport);
